...
public class DailyRealDispatch {
	...
	try {
	        ...
	        //
	        // obtención d ela solución del despacho
	        //
	        ...
	        if ( cplex.solve() ) {
	        	...
	        	//
	        	operator.getRealDispatch().setDispatchCost(cplex.getObjValue()); // valor de la función objetivo
	        	operator.getRealDispatch().setGeneration(Global.factory.vec2mat(cplex.getValues(var[0]),Global.nUnits,24)); // generación por unidad por hora
	        	operator.getRealDispatch().setVoltajeAngles(Global.factory.vec2mat(cplex.getValues(var[1]),Global.nNodes,24)); // ángulo de voltaje por nodo por hora
	            ...
	            for (int i = 0; i < 24; ++i) {
	            	...
	            	/*
		              ...
		              */
	            	flows[	0	+ i ]	=	susceptance[	0	] * y [	0	+ i ] -	susceptance[	0	] * y [	192	+ i ];	//
	            	flows[	24	+ i ]	=	susceptance[	1	] * y [	0	+ i ] -	susceptance[	1	] * y [	192	+ i ];	//
	            	flows[	48	+ i ]	=	susceptance[	2	] * y [	0	+ i ] -	susceptance[	2	] * y [	384	+ i ];	//
	            	flows[	72	+ i ]	=	susceptance[	3	] * y [	0	+ i ] -	susceptance[	3	] * y [	384	+ i ];	//
	            	flows[	96	+ i ]	=	susceptance[	4	] * y [	0	+ i ] -	susceptance[	4	] * y [	384	+ i ];	//
	            	flows[	120	+ i ]	=	susceptance[	5	] * y [	0	+ i ] -	susceptance[	5	] * y [	384	+ i ];	//
	            	flows[	144	+ i ]	=	susceptance[	6	] * y [	0	+ i ] -	susceptance[	6	] * y [	384	+ i ];	//
	            	flows[	168	+ i ]	=	susceptance[	7	] * y [	0	+ i ] -	susceptance[	7	] * y [	288	+ i ];	//
	            	flows[	192	+ i ]	=	susceptance[	8	] * y [	0	+ i ] -	susceptance[	8	] * y [	288	+ i ];	//
	            	flows[	216	+ i ]	=	susceptance[	9	] * y [	24	+ i ] -	susceptance[	9	] * y [	168	+ i ];	//
	            	flows[	240	+ i ]	=	susceptance[	10	] * y [	24	+ i ] -	susceptance[	10	] * y [	168	+ i ];	//
	            	flows[	264	+ i ]	=	susceptance[	11	] * y [	48	+ i ] -	susceptance[	11	] * y [	288	+ i ];	//
	            	flows[	288	+ i ]	=	susceptance[	12	] * y [	48	+ i ] -	susceptance[	12	] * y [	288	+ i ];	//
	            	flows[	312	+ i ]	=	susceptance[	13	] * y [	48	+ i ] -	susceptance[	13	] * y [	288	+ i ];	//
	            	flows[	336	+ i ]	=	susceptance[	14	] * y [	48	+ i ] -	susceptance[	14	] * y [	312	+ i ];	//
	            	flows[	360	+ i ]	=	susceptance[	15	] * y [	48	+ i ] -	susceptance[	15	] * y [	312	+ i ];	//
	            	flows[	384	+ i ]	=	susceptance[	16	] * y [	72	+ i ] -	susceptance[	16	] * y [	24	+ i ];	//
	            	flows[	408	+ i ]	=	susceptance[	17	] * y [	72	+ i ] -	susceptance[	17	] * y [	24	+ i ];	//
	            	flows[	432	+ i ]	=	susceptance[	18	] * y [	72	+ i ] -	susceptance[	18	] * y [	24	+ i ];	//
	            	flows[	456	+ i ]	=	susceptance[	19	] * y [	72	+ i ] -	susceptance[	19	] * y [	216	+ i ];	//
	            	flows[	480	+ i ]	=	susceptance[	20	] * y [	96	+ i ] -	susceptance[	20	] * y [	504	+ i ];	//
	            	flows[	504	+ i ]	=	susceptance[	21	] * y [	96	+ i ] -	susceptance[	21	] * y [	504	+ i ];	//
	            	flows[	528	+ i ]	=	susceptance[	22	] * y [	96	+ i ] -	susceptance[	22	] * y [	504	+ i ];	//
	            	flows[	552	+ i ]	=	susceptance[	23	] * y [	96	+ i ] -	susceptance[	23	] * y [	504	+ i ];	//
	            	flows[	576	+ i ]	=	susceptance[	24	] * y [	120	+ i ] -	susceptance[	24	] * y [	288	+ i ];	//
	            	flows[	600	+ i ]	=	susceptance[	25	] * y [	120	+ i ] -	susceptance[	25	] * y [	0	+ i ];	//
	            	flows[	624	+ i ]	=	susceptance[	26	] * y [	144	+ i ] -	susceptance[	26	] * y [	48	+ i ];	//
	            	flows[	648	+ i ]	=	susceptance[	27	] * y [	144	+ i ] -	susceptance[	27	] * y [	48	+ i ];	//
	            	flows[	672	+ i ]	=	susceptance[	28	] * y [	144	+ i ] -	susceptance[	28	] * y [	48	+ i ];	//
	            	flows[	696	+ i ]	=	susceptance[	29	] * y [	144	+ i ] -	susceptance[	29	] * y [	48	+ i ];	//
	            	flows[	720	+ i ]	=	susceptance[	30	] * y [	144	+ i ] -	susceptance[	30	] * y [	336	+ i ];	//
	            	flows[	744	+ i ]	=	susceptance[	31	] * y [	144	+ i ] -	susceptance[	31	] * y [	336	+ i ];	//
	            	flows[	768	+ i ]	=	susceptance[	32	] * y [	168	+ i ] -	susceptance[	32	] * y [	120	+ i ];	//
	            	flows[	792	+ i ]	=	susceptance[	33	] * y [	168	+ i ] -	susceptance[	33	] * y [	120	+ i ];	//
	            	flows[	816	+ i ]	=	susceptance[	34	] * y [	192	+ i ] -	susceptance[	34	] * y [	408	+ i ];	//
	            	flows[	840	+ i ]	=	susceptance[	35	] * y [	192	+ i ] -	susceptance[	35	] * y [	408	+ i ];	//
	            	flows[	864	+ i ]	=	susceptance[	36	] * y [	192	+ i ] -	susceptance[	36	] * y [	432	+ i ];	//
	            	flows[	888	+ i ]	=	susceptance[	37	] * y [	192	+ i ] -	susceptance[	37	] * y [	432	+ i ];	//
	            	flows[	912	+ i ]	=	susceptance[	38	] * y [	192	+ i ] -	susceptance[	38	] * y [	432	+ i ];	//
	            	flows[	936	+ i ]	=	susceptance[	39	] * y [	192	+ i ] -	susceptance[	39	] * y [	432	+ i ];	//
	            	flows[	960	+ i ]	=	susceptance[	40	] * y [	192	+ i ] -	susceptance[	40	] * y [	432	+ i ];	//
	            	flows[	984	+ i ]	=	susceptance[	41	] * y [	216	+ i ] -	susceptance[	41	] * y [	24	+ i ];	//
	            	flows[	1008	+ i ]	=	susceptance[	42	] * y [	216	+ i ] -	susceptance[	42	] * y [	24	+ i ];	//
	            	flows[	1032	+ i ]	=	susceptance[	43	] * y [	216	+ i ] -	susceptance[	43	] * y [	24	+ i ];	//
	            	flows[	1056	+ i ]	=	susceptance[	44	] * y [	216	+ i ] -	susceptance[	44	] * y [	336	+ i ];	//
	            	flows[	1080	+ i ]	=	susceptance[	45	] * y [	216	+ i ] -	susceptance[	45	] * y [	480	+ i ];	//
	            	flows[	1104	+ i ]	=	susceptance[	46	] * y [	240	+ i ] -	susceptance[	46	] * y [	96	+ i ];	//
	            	flows[	1128	+ i ]	=	susceptance[	47	] * y [	240	+ i ] -	susceptance[	47	] * y [	96	+ i ];	//
	            	flows[	1152	+ i ]	=	susceptance[	48	] * y [	240	+ i ] -	susceptance[	48	] * y [	96	+ i ];	//
	            	flows[	1176	+ i ]	=	susceptance[	49	] * y [	240	+ i ] -	susceptance[	49	] * y [	96	+ i ];	//
	            	flows[	1200	+ i ]	=	susceptance[	50	] * y [	240	+ i ] -	susceptance[	50	] * y [	408	+ i ];	//
	            	flows[	1224	+ i ]	=	susceptance[	51	] * y [	264	+ i ] -	susceptance[	51	] * y [	48	+ i ];	//
	            	flows[	1248	+ i ]	=	susceptance[	52	] * y [	264	+ i ] -	susceptance[	52	] * y [	48	+ i ];	//
	            	flows[	1272	+ i ]	=	susceptance[	53	] * y [	264	+ i ] -	susceptance[	53	] * y [	408	+ i ];	//
	            	flows[	1296	+ i ]	=	susceptance[	54	] * y [	264	+ i ] -	susceptance[	54	] * y [	408	+ i ];	//
	            	flows[	1320	+ i ]	=	susceptance[	55	] * y [	288	+ i ] -	susceptance[	55	] * y [	384	+ i ];	//
	            	flows[	1344	+ i ]	=	susceptance[	56	] * y [	288	+ i ] -	susceptance[	56	] * y [	384	+ i ];	//
	            	flows[	1368	+ i ]	=	susceptance[	57	] * y [	288	+ i ] -	susceptance[	57	] * y [	336	+ i ];	//
	            	flows[	1392	+ i ]	=	susceptance[	58	] * y [	288	+ i ] -	susceptance[	58	] * y [	336	+ i ];	//
	            	flows[	1416	+ i ]	=	susceptance[	59	] * y [	288	+ i ] -	susceptance[	59	] * y [	336	+ i ];	//
	            	flows[	1440	+ i ]	=	susceptance[	60	] * y [	288	+ i ] -	susceptance[	60	] * y [	336	+ i ];	//
	            	flows[	1464	+ i ]	=	susceptance[	61	] * y [	336	+ i ] -	susceptance[	61	] * y [	456	+ i ];	//
	            	flows[	1488	+ i ]	=	susceptance[	62	] * y [	336	+ i ] -	susceptance[	62	] * y [	456	+ i ];	//
	            	flows[	1512	+ i ]	=	susceptance[	63	] * y [	360	+ i ] -	susceptance[	63	] * y [	48	+ i ];	//
	            	flows[	1536	+ i ]	=	susceptance[	64	] * y [	360	+ i ] -	susceptance[	64	] * y [	48	+ i ];	//
	            	flows[	1560	+ i ]	=	susceptance[	65	] * y [	360	+ i ] -	susceptance[	65	] * y [	48	+ i ];	//
	            	flows[	1584	+ i ]	=	susceptance[	66	] * y [	360	+ i ] -	susceptance[	66	] * y [	48	+ i ];	//
	            	flows[	1608	+ i ]	=	susceptance[	67	] * y [	384	+ i ] -	susceptance[	67	] * y [	48	+ i ];	//
	            	flows[	1632	+ i ]	=	susceptance[	68	] * y [	384	+ i ] -	susceptance[	68	] * y [	48	+ i ];	//
	            	flows[	1656	+ i ]	=	susceptance[	69	] * y [	384	+ i ] -	susceptance[	69	] * y [	192	+ i ];	//
	            	flows[	1680	+ i ]	=	susceptance[	70	] * y [	384	+ i ] -	susceptance[	70	] * y [	192	+ i ];	//
	            	flows[	1704	+ i ]	=	susceptance[	71	] * y [	384	+ i ] -	susceptance[	71	] * y [	432	+ i ];	//
	            	flows[	1728	+ i ]	=	susceptance[	72	] * y [	408	+ i ] -	susceptance[	72	] * y [	48	+ i ];	//
	            	flows[	1752	+ i ]	=	susceptance[	73	] * y [	408	+ i ] -	susceptance[	73	] * y [	48	+ i ];	//
	            	flows[	1776	+ i ]	=	susceptance[	74	] * y [	408	+ i ] -	susceptance[	74	] * y [	48	+ i ];	//
	            	flows[	1800	+ i ]	=	susceptance[	75	] * y [	408	+ i ] -	susceptance[	75	] * y [	48	+ i ];	//
	            	flows[	1824	+ i ]	=	susceptance[	76	] * y [	432	+ i ] -	susceptance[	76	] * y [	96	+ i ];	//
	            	flows[	1848	+ i ]	=	susceptance[	77	] * y [	432	+ i ] -	susceptance[	77	] * y [	96	+ i ];	//
	            	flows[	1872	+ i ]	=	susceptance[	78	] * y [	0	+ i ] -	susceptance[	78	] * y [	288	+ i ];	//
	            	flows[	1896	+ i ]	=	susceptance[	79	] * y [	0	+ i ] -	susceptance[	79	] * y [	120	+ i ];	//
	            	flows[	1920	+ i ]	=	susceptance[	80	] * y [	120	+ i ] -	susceptance[	80	] * y [	216	+ i ];	//
	            	flows[	1944	+ i ]	=	susceptance[	81	] * y [	288	+ i ] -	susceptance[	81	] * y [	48	+ i ];	//
	            	flows[	1968	+ i ]	=	susceptance[	82	] * y [	0	+ i ] -	susceptance[	82	] * y [	432	+ i ];	//
	            	flows[	1992	+ i ]	=	susceptance[	83	] * y [	432	+ i ] -	susceptance[	83	] * y [	48	+ i ];	//
	            	flows[	2016	+ i ]	=	susceptance[	84	] * y [	432	+ i ] -	susceptance[	84	] * y [	96	+ i ];	//
	            	flows[	2040	+ i ]	=	susceptance[	85	] * y [	96	+ i ] -	susceptance[	85	] * y [	504	+ i ];	//
	            	flows[	2064	+ i ]	=	susceptance[	86	] * y [	120	+ i ] -	susceptance[	86	] * y [	528	+ i ];	//
	            	flows[	2088	+ i ]	=	susceptance[	87	] * y [	48	+ i ] -	susceptance[	87	] * y [	312	+ i ];	//
	            	flows[	2112	+ i ]	=	susceptance[	88	] * y [	48	+ i ] -	susceptance[	88	] * y [	312	+ i ];	//
	            	flows[	2136	+ i ]	=	susceptance[	89	] * y [	168	+ i ] -	susceptance[	89	] * y [	120	+ i ];	//
	            	flows[	2160	+ i ]	=	susceptance[	90	] * y [	240	+ i ] -	susceptance[	90	] * y [	432	+ i ];	//
	            	flows[	2184	+ i ]	=	susceptance[	91	] * y [	240	+ i ] -	susceptance[	91	] * y [	432	+ i ];	//
	            	flows[	2208	+ i ]	=	susceptance[	92	] * y [	144	+ i ] -	susceptance[	92	] * y [	48	+ i ];	//
	            	flows[	2232	+ i ]	=	susceptance[	93	] * y [	144	+ i ] -	susceptance[	93	] * y [	48	+ i ];	//
	            }
	            
	            //
	            // resultados flujos
	            //
	            operator.getRealDispatch().setFlows(Global.factory.vec2mat(flows,Global.nLines,24)); // flujos por las líneas de transmisión para cada hora
	            ...
	            //
	            // cálculo de la demanda efectívamente atendida
	            //
	            double[][] unservedDemand = Global.factory.vec2mat(cplex.getValues(var[2]),Global.nNodes,24); // demanda no atendida por nodo por hora
	            double[][] servedDemand = new double[Global.nNodes][24];
	            for (int i = 0; i < Global.nNodes; i++)
	            {
	            	for (int h = 0; h < 24; h++)
	            	{
	            		servedDemand[i][h] = powerDemandVector[i][h] - unservedDemand[i][h];
	            	}
	            }
	            ...
	            operator.getRealDispatch().setEnergyBid(powerBid); 		   		// guardar la oferta de energía por cada unidad para cada hora
	            operator.getRealDispatch().setEnergyBidPrice(powerBidPrice);	// guardar el precio de la oferta de energía por cada unidad para cada hora
	            operator.getRealDispatch().setRemainderCapacity(differences);	// capacidad de transmisión remanente en cada línea en cada hora
	            operator.getRealDispatch().setServedDemand(servedDemand);		// guardar la demanda efectívamente atendida en cada nodo
	        	//
	...
	//
	//  estructura del problema de optimización
	//
	...
	static void populateByRow(IloMPModeler model, IloNumVar[][] var, IloRange[][] rng, String[] var1, String[] var2, String[] var3, 
		...
		// variables
		//
		IloNumVar[] generation  = model.numVarArray(24*Global.nUnits, lowPowerLimit, powerBid, var1); 	// programación de la generación 
		...
		var[0] = generation; 	// programación de la genración
		...
		// función objetivo
		//
		// Minimizar el costo de la generación
		// model.addMinimize(model.scalProd(generation, generationCost));
		// Minimizar el costo de la genración y de la demanda no atendida
		...
		for (int i = 0; i < 24; i++){
			IloNumExpr[] expr = {
					...
					model.prod(susceptance[	1	] +
							...
							susceptance[	25	] 
 , angle[0+i]),
 model.prod(-susceptance[	1	],	angle[	192	+ i	]),
 model.prod(-susceptance[	2	],	angle[	384	+ i	]),
 model.prod(-susceptance[	3	],	angle[	384	+ i	]),
 model.prod(-susceptance[	4	],	angle[	384	+ i	]),
 model.prod(-susceptance[	5	],	angle[	384	+ i	]),
 model.prod(-susceptance[	6	],	angle[	384	+ i	]),
 model.prod(-susceptance[	7	],	angle[	288	+ i	]),
 model.prod(-susceptance[	8	],	angle[	288	+ i	]),
 model.prod(-susceptance[	78	],	angle[	288	+ i	]),
 model.prod(-susceptance[	79	],	angle[	120	+ i	]),
 model.prod(-susceptance[	82	],	angle[	432	+ i	]),
 model.prod(-susceptance[	0	],	angle[	192	+ i	]),
 model.prod(-susceptance[	25	],	angle[	120	+ i	])};

// SUS[CER-ANT]	* VA_CERROMAT 	
		...
		for (int i = 0; i < 24; i++){
			IloNumExpr[] expr = {
					...
					model.prod(susceptance[	9	] +
							...
							susceptance[	43	] 
, angle[24+i]),
model.prod(-susceptance[	9	],	angle[	168	+ i	]),
model.prod(-susceptance[	10	],	angle[	168	+ i	]),
model.prod(-susceptance[	16	],	angle[	72	+ i	]),
model.prod(-susceptance[	17	],	angle[	72	+ i	]),
model.prod(-susceptance[	18	],	angle[	72	+ i	]),
model.prod(-susceptance[	41	],	angle[	216	+ i	]),
model.prod(-susceptance[	42	],	angle[	216	+ i	]),
model.prod(-susceptance[	43	],	angle[	216	+ i	])};
		...
		for (int i = 0; i < 24; i++){
			IloNumExpr[] expr = {
					...
					model.prod(susceptance[	11	] +
							...
							susceptance[	93	] 
, angle[48+i]),
model.prod(-susceptance[	11	],	angle[	288	+ i	]),
model.prod(-susceptance[	12	],	angle[	288	+ i	]),
model.prod(-susceptance[	13	],	angle[	288	+ i	]),
model.prod(-susceptance[	14	],	angle[	312	+ i	]),
model.prod(-susceptance[	15	],	angle[	312	+ i	]),
model.prod(-susceptance[	87	],	angle[	312	+ i	]),
model.prod(-susceptance[	88	],	angle[	312	+ i	]),
model.prod(-susceptance[	26	],	angle[	144	+ i	]),
model.prod(-susceptance[	27	],	angle[	144	+ i	]),
model.prod(-susceptance[	28	],	angle[	144	+ i	]),
model.prod(-susceptance[	29	],	angle[	144	+ i	]),
model.prod(-susceptance[	51	],	angle[	264	+ i	]),
model.prod(-susceptance[	52	],	angle[	264	+ i	]),
model.prod(-susceptance[	63	],	angle[	360	+ i	]),
model.prod(-susceptance[	64	],	angle[	360	+ i	]),
model.prod(-susceptance[	65	],	angle[	360	+ i	]),
model.prod(-susceptance[	66	],	angle[	360	+ i	]),
model.prod(-susceptance[	67	],	angle[	384	+ i	]),
model.prod(-susceptance[	68	],	angle[	384	+ i	]),
model.prod(-susceptance[	72	],	angle[	408	+ i	]),
model.prod(-susceptance[	73	],	angle[	408	+ i	]),
model.prod(-susceptance[	74	],	angle[	408	+ i	]),
model.prod(-susceptance[	75	],	angle[	408	+ i	]),
model.prod(-susceptance[	81	],	angle[	288	+ i	]),
model.prod(-susceptance[	83	],	angle[	432	+ i	]),
model.prod(-susceptance[	92	],	angle[	144	+ i	]),
model.prod(-susceptance[	93	],	angle[	144	+ i	])};

// SUS[TOL-BOG] * VA_TOLIMA
		...
		*/
		...
		for (int i = 0; i < 24; i++){
			IloNumExpr[] expr = {
					...
					model.prod(susceptance[	16	] +
							susceptance[	17	] +
							susceptance[	18	] +
							susceptance[	19	] 
, angle[72+i]),
model.prod(-susceptance[	16	],	angle[	24	+ i	]),
model.prod(-susceptance[	17	],	angle[	24	+ i	]),
model.prod(-susceptance[	18	],	angle[	24	+ i	]),
model.prod(-susceptance[	19	],	angle[	216	+ i	])};
		...
		for (int i = 0; i < 24; i++){
			IloNumExpr[] expr = {
					...
					model.prod(susceptance[	20	] +
							...
							susceptance[	84	] 
, angle[96+i]),
model.prod(-susceptance[	20	],	angle[	504	+ i	]),
model.prod(-susceptance[	21	],	angle[	504	+ i	]),
model.prod(-susceptance[	22	],	angle[	504	+ i	]),
model.prod(-susceptance[	23	],	angle[	504	+ i	]),
model.prod(-susceptance[	85	],	angle[	504	+ i	]),
model.prod(-susceptance[	46	],	angle[	240	+ i	]),
model.prod(-susceptance[	47	],	angle[	240	+ i	]),
model.prod(-susceptance[	48	],	angle[	240	+ i	]),
model.prod(-susceptance[	49	],	angle[	240	+ i	]),
model.prod(-susceptance[	76	],	angle[	432	+ i	]),
model.prod(-susceptance[	77	],	angle[	432	+ i	]),
model.prod(-susceptance[	84	],	angle[	432	+ i	])};

	// SUS[VAL-CAU] * VA_VALLECAU
		...
		for (int i = 0; i < 24; i++){
			IloNumExpr[] expr = {
					...
					model.prod(susceptance[	24	] +
							...
							susceptance[	89	] 
, angle[120+i]),
model.prod(-susceptance[	24	],	angle[	288	+ i	]),
model.prod(-susceptance[	25	],	angle[	0	+ i	]),
model.prod(-susceptance[	80	],	angle[	216	+ i	]),
model.prod(-susceptance[	86	],	angle[	528	+ i	]),
model.prod(-susceptance[	32	],	angle[	168	+ i	]),
model.prod(-susceptance[	33	],	angle[	168	+ i	]),
model.prod(-susceptance[	79	],	angle[	0	+ i	]),
model.prod(-susceptance[	89	],	angle[	168	+ i	])};

	// SUS[CDS-CER] * VA_CORDOSUC
		...
		for (int i = 0; i < 24; i++){
			IloNumExpr[] expr = {
					...
					model.prod(susceptance[	26	] +
							...
							susceptance[	93	] 
, angle[144+i]),
model.prod(-susceptance[	26	],	angle[	48	+ i	]),
model.prod(-susceptance[	27	],	angle[	48	+ i	]),
model.prod(-susceptance[	28	],	angle[	48	+ i	]),
model.prod(-susceptance[	29	],	angle[	48	+ i	]),
model.prod(-susceptance[	30	],	angle[	336	+ i	]),
model.prod(-susceptance[	31	],	angle[	336	+ i	]),
model.prod(-susceptance[	92	],	angle[	48	+ i	]),
model.prod(-susceptance[	93	],	angle[	48	+ i	])};

	// SUS[CHI-NOR] * VA_NORDESTE
		...
		*/
		for (int i = 0; i < 24; i++){
			IloNumExpr[] expr = {
					...
					model.prod(susceptance[	32	] +
							susceptance[	33	] +
							susceptance[	89	] +
							susceptance[	9	] +
							susceptance[	10	] 
, angle[168+i]),
model.prod(-susceptance[	32	],	angle[	120	+ i	]),
model.prod(-susceptance[	33	],	angle[	120	+ i	]),
model.prod(-susceptance[	89	],	angle[	120	+ i	]),
model.prod(-susceptance[	9	],	angle[	24	+ i	]),
model.prod(-susceptance[	10	],	angle[	24	+ i	])};
		...
		for (int i = 0; i < 24; i++){
			IloNumExpr[] expr = {
					...
					model.prod(susceptance[	34	] +
							...
							susceptance[	0	] 
, angle[192+i]),
model.prod(-susceptance[	34	],	angle[	408	+ i	]),
model.prod(-susceptance[	35	],	angle[	408	+ i	]),
model.prod(-susceptance[	36	],	angle[	432	+ i	]),
model.prod(-susceptance[	37	],	angle[	432	+ i	]),
model.prod(-susceptance[	38	],	angle[	432	+ i	]),
model.prod(-susceptance[	39	],	angle[	432	+ i	]),
model.prod(-susceptance[	40	],	angle[	432	+ i	]),
model.prod(-susceptance[	1	],	angle[	0	+ i	]),
model.prod(-susceptance[	69	],	angle[	384	+ i	]),
model.prod(-susceptance[	70	],	angle[	384	+ i	]),
model.prod(-susceptance[	0	],	angle[	0	+ i	])};

	// SUS[SCA-CQR] * VA_SANCARLO
		...
		for (int i = 0; i < 24; i++){
			IloNumExpr[] expr = {
					...
					model.prod(susceptance[	41	] +
							...
							susceptance[	80	] 
, angle[216+i]),
model.prod(-susceptance[	41	],	angle[	24	+ i	]),
model.prod(-susceptance[	42	],	angle[	24	+ i	]),
model.prod(-susceptance[	43	],	angle[	24	+ i	]),
model.prod(-susceptance[	44	],	angle[	336	+ i	]),
model.prod(-susceptance[	45	],	angle[	480	+ i	]),
model.prod(-susceptance[	19	],	angle[	72	+ i	]),
model.prod(-susceptance[	80	],	angle[	120	+ i	])};

	// SUS[BOL-GCM] * VA_BOLIVAR
		...
		for (int i = 0; i < 24; i++){
			IloNumExpr[] expr = {
					...
					model.prod(susceptance[	46	] +
							...
							susceptance[	91	] 
, angle[240+i]),
model.prod(-susceptance[	46	],	angle[	96	+ i	]),
model.prod(-susceptance[	47	],	angle[	96	+ i	]),
model.prod(-susceptance[	48	],	angle[	96	+ i	]),
model.prod(-susceptance[	49	],	angle[	96	+ i	]),
model.prod(-susceptance[	50	],	angle[	408	+ i	]),
model.prod(-susceptance[	90	],	angle[	432	+ i	]),
model.prod(-susceptance[	91	],	angle[	432	+ i	])};

	// SUS[HUI-TOL] * VA_TOLIMA
		...
		*/
		for (int i = 0; i < 24; i++){
			IloNumExpr[] expr = {
					...
					model.prod(susceptance[	51	] +
							susceptance[	52	] +
							susceptance[	53	] +
							susceptance[	54	] 
, angle[264+i]),
model.prod(-susceptance[	51	],	angle[	48	+ i	]),
model.prod(-susceptance[	52	],	angle[	48	+ i	]),
model.prod(-susceptance[	53	],	angle[	408	+ i	]),
model.prod(-susceptance[	54	],	angle[	408	+ i	])};

	// SUS[MIE-TOL] * VA_TOLIMA
		...
		for (int i = 0; i < 24; i++){
			IloNumExpr[] expr = {
					...
					model.prod(susceptance[	55	] +
							...
							susceptance[	78	] 
, angle[288+i]),
model.prod(-susceptance[	55	],	angle[	384	+ i	]),
model.prod(-susceptance[	56	],	angle[	384	+ i	]),
model.prod(-susceptance[	57	],	angle[	336	+ i	]),
model.prod(-susceptance[	58	],	angle[	336	+ i	]),
model.prod(-susceptance[	59	],	angle[	336	+ i	]),
model.prod(-susceptance[	60	],	angle[	336	+ i	]),
model.prod(-susceptance[	81	],	angle[	48	+ i	]),
model.prod(-susceptance[	7	],	angle[	0	+ i	]),
model.prod(-susceptance[	8	],	angle[	0	+ i	]),
model.prod(-susceptance[	11	],	angle[	48	+ i	]),
model.prod(-susceptance[	12	],	angle[	48	+ i	]),
model.prod(-susceptance[	13	],	angle[	48	+ i	]),
model.prod(-susceptance[	24	],	angle[	120	+ i	]),
model.prod(-susceptance[	78	],	angle[	0	+ i	])};

	// SUS[CER-MAG] * VA_CERROMAT
		...
		*/
		for (int i = 0; i < 24; i++){
			IloNumExpr[] expr = {
					unserved[312+i],
					// (SUS[BOG-MET]) * VA_META
					model.prod(susceptance[	14	] +
							susceptance[	15	] +
							susceptance[	87	] +
							susceptance[	88	] 
, angle[312+i]),
model.prod(-susceptance[	14	],	angle[	48	+ i	]),
model.prod(-susceptance[	15	],	angle[	48	+ i	]),
model.prod(-susceptance[	87	],	angle[	48	+ i	]),
model.prod(-susceptance[	88	],	angle[	48	+ i	])};

	// SUS[BOG-MET] * VA_BOGOTA
		...
		for (int i = 0; i < 24; i++){
			IloNumExpr[] expr = {
					...
					model.prod(susceptance[	61	] +
							...
							susceptance[	60	] 
, angle[336+i]),
model.prod(-susceptance[	61	],	angle[	456	+ i	]),
model.prod(-susceptance[	62	],	angle[	456	+ i	]),
model.prod(-susceptance[	30	],	angle[	144	+ i	]),
model.prod(-susceptance[	31	],	angle[	144	+ i	]),
model.prod(-susceptance[	44	],	angle[	216	+ i	]),
model.prod(-susceptance[	57	],	angle[	288	+ i	]),
model.prod(-susceptance[	58	],	angle[	288	+ i	]),
model.prod(-susceptance[	59	],	angle[	288	+ i	]),
model.prod(-susceptance[	60	],	angle[	288	+ i	])};

	// SUS[MAG-NOR] * VA_MAGDAMED
		...
		*/
		for (int i = 0; i < 24; i++){
			IloNumExpr[] expr = {
					...
					model.prod(susceptance[	63	] +
							susceptance[	64	] +
							susceptance[	65	] +
							susceptance[	66	] 
, angle[360+i]),
model.prod(-susceptance[	63	],	angle[	48	+ i	]),
model.prod(-susceptance[	64	],	angle[	48	+ i	]),
model.prod(-susceptance[	65	],	angle[	48	+ i	]),
model.prod(-susceptance[	66	],	angle[	48	+ i	])};

	// SUS[PAG-BOG] * VA_BOGOTA
		...
		for (int i = 0; i < 24; i++){
			IloNumExpr[] expr = {
					...
					model.prod(susceptance[	67	] +
							...
							susceptance[	56	] 
, angle[384+i]),
model.prod(-susceptance[	67	],	angle[	48	+ i	]),
model.prod(-susceptance[	68	],	angle[	48	+ i	]),
model.prod(-susceptance[	69	],	angle[	192	+ i	]),
model.prod(-susceptance[	70	],	angle[	192	+ i	]),
model.prod(-susceptance[	71	],	angle[	432	+ i	]),
model.prod(-susceptance[	2	],	angle[	0	+ i	]),
model.prod(-susceptance[	3	],	angle[	0	+ i	]),
model.prod(-susceptance[	4	],	angle[	0	+ i	]),
model.prod(-susceptance[	5	],	angle[	0	+ i	]),
model.prod(-susceptance[	6	],	angle[	0	+ i	]),
model.prod(-susceptance[	55	],	angle[	288	+ i	]),
model.prod(-susceptance[	56	],	angle[	288	+ i	])};

	// SUS[MAG-SCA] * VA_MAGDAMED
		...
		for (int i = 0; i < 24; i++){
			IloNumExpr[] expr = {
					...
					model.prod(susceptance[	72	] +
							...
							susceptance[	54	] 
, angle[408+i]),
model.prod(-susceptance[	72	],	angle[	48	+ i	]),
model.prod(-susceptance[	73	],	angle[	48	+ i	]),
model.prod(-susceptance[	74	],	angle[	48	+ i	]),
model.prod(-susceptance[	75	],	angle[	48	+ i	]),
model.prod(-susceptance[	34	],	angle[	192	+ i	]),
model.prod(-susceptance[	35	],	angle[	192	+ i	]),
model.prod(-susceptance[	50	],	angle[	240	+ i	]),
model.prod(-susceptance[	53	],	angle[	264	+ i	]),
model.prod(-susceptance[	54	],	angle[	264	+ i	])};

	// SUS[MIE-TOL] * VA_LAMIEL
		...
		for (int i = 0; i < 24; i++){
			IloNumExpr[] expr = {
					...
					model.prod(susceptance[	76	] +
							...
							susceptance[	91	] 
, angle[432+i]),
model.prod(-susceptance[	76	],	angle[	96	+ i	]),
model.prod(-susceptance[	77	],	angle[	96	+ i	]),
model.prod(-susceptance[	83	],	angle[	48	+ i	]),
model.prod(-susceptance[	84	],	angle[	96	+ i	]),
model.prod(-susceptance[	36	],	angle[	192	+ i	]),
model.prod(-susceptance[	37	],	angle[	192	+ i	]),
model.prod(-susceptance[	38	],	angle[	192	+ i	]),
model.prod(-susceptance[	39	],	angle[	192	+ i	]),
model.prod(-susceptance[	40	],	angle[	192	+ i	]),
model.prod(-susceptance[	71	],	angle[	384	+ i	]),
model.prod(-susceptance[	82	],	angle[	0	+ i	]),
model.prod(-susceptance[	90	],	angle[	240	+ i	]),
model.prod(-susceptance[	91	],	angle[	240	+ i	])};

	// SUS[SCA-VAL] * VA_SANCARLO
		...
		for (int i = 0; i < 24; i++){
			IloNumExpr[] expr = {
					...
					model.prod(susceptance[	61	] +
							susceptance[	62	] 
, angle[456+i]),
model.prod(-susceptance[	61	],	angle[	336	+ i	]),
model.prod(-susceptance[	62	],	angle[	336	+ i	])};

	// SUS[VAL-CAU] * VA_NORDESTE
		...
		*/
		for (int i = 0; i < 24; i++){
			IloNumExpr[] expr = {
					...
					model.prod(susceptance[45], angle[480+i]),
					model.prod(-susceptance[	45	],	angle[	216	+ i	])};
					// SUS[GCM-CUA] * VA_GCM
		...
		for (int i = 0; i < 24; i++){
			IloNumExpr[] expr = {
					...
					model.prod(susceptance[	20	] +
							...
							susceptance[	85	] 
, angle[504+i]),
model.prod(-susceptance[	20	],	angle[	96	+ i	]),
model.prod(-susceptance[	21	],	angle[	96	+ i	]),
model.prod(-susceptance[	22	],	angle[	96	+ i	]),
model.prod(-susceptance[	23	],	angle[	96	+ i	]),
model.prod(-susceptance[	85	],	angle[	96	+ i	])};

	// SUS[CAU-ECU] * VA_CAUCANAR
		...
		/* Balance oferta y demanda PANAMA
		...
		*/
		for (int i = 0; i < 24; i++){
			IloNumExpr[] expr = {
					generation[	2784	+ i ],
					unserved[528+i],
					// (SUS[CERR-PAN]) * VA_PANAMA
					model.prod(susceptance[	86	] 
, angle[528+i]),
model.prod(-susceptance[	86	],	angle[	120	+ i	])};

	// SUS[CERR-PAN] * VA_CERR
			
			rng[0][528+i] = model.addGe(
					model.sum(expr), 	
					powerDemandVector[22][i], "C_PANAMA_"+i); 
		}
		...
		for (int i = 0; i < 24; ++i) 
		{
			...
			*/
			...
			rng[1][	1824	+ i ]	=	model.addLe(model.diff(model.prod(	susceptance[	76	],	angle[	432	+ i ]),	model.prod(	susceptance[	76	],	angle[	96	+ i ])),	powerLimit[	76	],	"c4_77");
			rng[1][	1848	+ i ]	=	model.addLe(model.diff(model.prod(	susceptance[	77	],	angle[	432	+ i ]),	model.prod(	susceptance[	77	],	angle[	96	+ i ])),	powerLimit[	77	],	"c4_78");
			rng[1][	1872	+ i ]	=	model.addLe(model.diff(model.prod(	susceptance[	78	],	angle[	0	+ i ]),	model.prod(	susceptance[	78	],	angle[	288	+ i ])),	powerLimit[	78	],	"c4_79");
			rng[1][	1896	+ i ]	=	model.addLe(model.diff(model.prod(	susceptance[	79	],	angle[	0	+ i ]),	model.prod(	susceptance[	79	],	angle[	120	+ i ])),	powerLimit[	79	],	"c4_80");
			rng[1][	1920	+ i ]	=	model.addLe(model.diff(model.prod(	susceptance[	80	],	angle[	120	+ i ]),	model.prod(	susceptance[	80	],	angle[	216	+ i ])),	powerLimit[	80	],	"c4_81");
			rng[1][	1944	+ i ]	=	model.addLe(model.diff(model.prod(	susceptance[	81	],	angle[	288	+ i ]),	model.prod(	susceptance[	81	],	angle[	48	+ i ])),	powerLimit[	81	],	"c4_82");
			rng[1][	1968	+ i ]	=	model.addLe(model.diff(model.prod(	susceptance[	82	],	angle[	0	+ i ]),	model.prod(	susceptance[	82	],	angle[	432	+ i ])),	powerLimit[	82	],	"c4_83");
			rng[1][	1992	+ i ]	=	model.addLe(model.diff(model.prod(	susceptance[	83	],	angle[	432	+ i ]),	model.prod(	susceptance[	83	],	angle[	48	+ i ])),	powerLimit[	83	],	"c4_84");
			rng[1][	2016	+ i ]	=	model.addLe(model.diff(model.prod(	susceptance[	84	],	angle[	432	+ i ]),	model.prod(	susceptance[	84	],	angle[	96	+ i ])),	powerLimit[	84	],	"c4_85");
			rng[1][	2040	+ i ]	=	model.addLe(model.diff(model.prod(	susceptance[	85	],	angle[	96	+ i ]),	model.prod(	susceptance[	85	],	angle[	504	+ i ])),	powerLimit[	85	],	"c4_86");
			rng[1][	2064	+ i ]	=	model.addLe(model.diff(model.prod(	susceptance[	86	],	angle[	120	+ i ]),	model.prod(	susceptance[	86	],	angle[	528	+ i ])),	powerLimit[	86	],	"c4_87");
			rng[1][	2088	+ i ]	=	model.addLe(model.diff(model.prod(	susceptance[	87	],	angle[	48	+ i ]),	model.prod(	susceptance[	87	],	angle[	312	+ i ])),	powerLimit[	87	],	"c4_88");
			rng[1][	2112	+ i ]	=	model.addLe(model.diff(model.prod(	susceptance[	88	],	angle[	48	+ i ]),	model.prod(	susceptance[	88	],	angle[	312	+ i ])),	powerLimit[	88	],	"c4_89");
			rng[1][	2136	+ i ]	=	model.addLe(model.diff(model.prod(	susceptance[	89	],	angle[	168	+ i ]),	model.prod(	susceptance[	89	],	angle[	120	+ i ])),	powerLimit[	89	],	"c4_90");
			rng[1][	2160	+ i ]	=	model.addLe(model.diff(model.prod(	susceptance[	90	],	angle[	240	+ i ]),	model.prod(	susceptance[	90	],	angle[	432	+ i ])),	powerLimit[	90	],	"c4_91");
			rng[1][	2184	+ i ]	=	model.addLe(model.diff(model.prod(	susceptance[	91	],	angle[	240	+ i ]),	model.prod(	susceptance[	91	],	angle[	432	+ i ])),	powerLimit[	91	],	"c4_92");
			rng[1][	2208	+ i ]	=	model.addLe(model.diff(model.prod(	susceptance[	92	],	angle[	144	+ i ]),	model.prod(	susceptance[	92	],	angle[	48	+ i ])),	powerLimit[	92	],	"c4_93");
			rng[1][	2232	+ i ]	=	model.addLe(model.diff(model.prod(	susceptance[	93	],	angle[	144	+ i ]),	model.prod(	susceptance[	93	],	angle[	48	+ i ])),	powerLimit[	93	],	"c4_94");
		}
	 ...
	 for (int i = 0; i < 24; ++i) 
	 {
		 ...
		 */
		 ...
		 rng[1][	2256 + 	0	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	0	],	angle[	0	+ i ]),	model.prod(	susceptance[	0	],	angle[	192	+ i ])),	-powerLimit[	0	],	"c5_1");
		 rng[1][	2256 + 	24	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	1	],	angle[	0	+ i ]),	model.prod(	susceptance[	1	],	angle[	192	+ i ])),	-powerLimit[	1	],	"c5_2");
		 rng[1][	2256 + 	48	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	2	],	angle[	0	+ i ]),	model.prod(	susceptance[	2	],	angle[	384	+ i ])),	-powerLimit[	2	],	"c5_3");
		 rng[1][	2256 + 	72	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	3	],	angle[	0	+ i ]),	model.prod(	susceptance[	3	],	angle[	384	+ i ])),	-powerLimit[	3	],	"c5_4");
		 rng[1][	2256 + 	96	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	4	],	angle[	0	+ i ]),	model.prod(	susceptance[	4	],	angle[	384	+ i ])),	-powerLimit[	4	],	"c5_5");
		 rng[1][	2256 + 	120	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	5	],	angle[	0	+ i ]),	model.prod(	susceptance[	5	],	angle[	384	+ i ])),	-powerLimit[	5	],	"c5_6");
		 rng[1][	2256 + 	144	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	6	],	angle[	0	+ i ]),	model.prod(	susceptance[	6	],	angle[	384	+ i ])),	-powerLimit[	6	],	"c5_7");
		 rng[1][	2256 + 	168	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	7	],	angle[	0	+ i ]),	model.prod(	susceptance[	7	],	angle[	288	+ i ])),	-powerLimit[	7	],	"c5_8");
		 rng[1][	2256 + 	192	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	8	],	angle[	0	+ i ]),	model.prod(	susceptance[	8	],	angle[	288	+ i ])),	-powerLimit[	8	],	"c5_9");
		 rng[1][	2256 + 	216	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	9	],	angle[	24	+ i ]),	model.prod(	susceptance[	9	],	angle[	168	+ i ])),	-powerLimit[	9	],	"c5_10");
		 rng[1][	2256 + 	240	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	10	],	angle[	24	+ i ]),	model.prod(	susceptance[	10	],	angle[	168	+ i ])),	-powerLimit[	10	],	"c5_11");
		 rng[1][	2256 + 	264	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	11	],	angle[	48	+ i ]),	model.prod(	susceptance[	11	],	angle[	288	+ i ])),	-powerLimit[	11	],	"c5_12");
		 rng[1][	2256 + 	288	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	12	],	angle[	48	+ i ]),	model.prod(	susceptance[	12	],	angle[	288	+ i ])),	-powerLimit[	12	],	"c5_13");
		 rng[1][	2256 + 	312	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	13	],	angle[	48	+ i ]),	model.prod(	susceptance[	13	],	angle[	288	+ i ])),	-powerLimit[	13	],	"c5_14");
		 rng[1][	2256 + 	336	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	14	],	angle[	48	+ i ]),	model.prod(	susceptance[	14	],	angle[	312	+ i ])),	-powerLimit[	14	],	"c5_15");
		 rng[1][	2256 + 	360	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	15	],	angle[	48	+ i ]),	model.prod(	susceptance[	15	],	angle[	312	+ i ])),	-powerLimit[	15	],	"c5_16");
		 rng[1][	2256 + 	384	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	16	],	angle[	72	+ i ]),	model.prod(	susceptance[	16	],	angle[	24	+ i ])),	-powerLimit[	16	],	"c5_17");
		 rng[1][	2256 + 	408	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	17	],	angle[	72	+ i ]),	model.prod(	susceptance[	17	],	angle[	24	+ i ])),	-powerLimit[	17	],	"c5_18");
		 rng[1][	2256 + 	432	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	18	],	angle[	72	+ i ]),	model.prod(	susceptance[	18	],	angle[	24	+ i ])),	-powerLimit[	18	],	"c5_19");
		 rng[1][	2256 + 	456	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	19	],	angle[	72	+ i ]),	model.prod(	susceptance[	19	],	angle[	216	+ i ])),	-powerLimit[	19	],	"c5_20");
		 rng[1][	2256 + 	480	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	20	],	angle[	96	+ i ]),	model.prod(	susceptance[	20	],	angle[	504	+ i ])),	-powerLimit[	20	],	"c5_21");
		 rng[1][	2256 + 	504	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	21	],	angle[	96	+ i ]),	model.prod(	susceptance[	21	],	angle[	504	+ i ])),	-powerLimit[	21	],	"c5_22");
		 rng[1][	2256 + 	528	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	22	],	angle[	96	+ i ]),	model.prod(	susceptance[	22	],	angle[	504	+ i ])),	-powerLimit[	22	],	"c5_23");
		 rng[1][	2256 + 	552	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	23	],	angle[	96	+ i ]),	model.prod(	susceptance[	23	],	angle[	504	+ i ])),	-powerLimit[	23	],	"c5_24");
		 rng[1][	2256 + 	576	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	24	],	angle[	120	+ i ]),	model.prod(	susceptance[	24	],	angle[	288	+ i ])),	-powerLimit[	24	],	"c5_25");
		 rng[1][	2256 + 	600	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	25	],	angle[	120	+ i ]),	model.prod(	susceptance[	25	],	angle[	0	+ i ])),	-powerLimit[	25	],	"c5_26");
		 rng[1][	2256 + 	624	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	26	],	angle[	144	+ i ]),	model.prod(	susceptance[	26	],	angle[	48	+ i ])),	-powerLimit[	26	],	"c5_27");
		 rng[1][	2256 + 	648	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	27	],	angle[	144	+ i ]),	model.prod(	susceptance[	27	],	angle[	48	+ i ])),	-powerLimit[	27	],	"c5_28");
		 rng[1][	2256 + 	672	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	28	],	angle[	144	+ i ]),	model.prod(	susceptance[	28	],	angle[	48	+ i ])),	-powerLimit[	28	],	"c5_29");
		 rng[1][	2256 + 	696	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	29	],	angle[	144	+ i ]),	model.prod(	susceptance[	29	],	angle[	48	+ i ])),	-powerLimit[	29	],	"c5_30");
		 rng[1][	2256 + 	720	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	30	],	angle[	144	+ i ]),	model.prod(	susceptance[	30	],	angle[	336	+ i ])),	-powerLimit[	30	],	"c5_31");
		 rng[1][	2256 + 	744	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	31	],	angle[	144	+ i ]),	model.prod(	susceptance[	31	],	angle[	336	+ i ])),	-powerLimit[	31	],	"c5_32");
		 rng[1][	2256 + 	768	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	32	],	angle[	168	+ i ]),	model.prod(	susceptance[	32	],	angle[	120	+ i ])),	-powerLimit[	32	],	"c5_33");
		 rng[1][	2256 + 	792	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	33	],	angle[	168	+ i ]),	model.prod(	susceptance[	33	],	angle[	120	+ i ])),	-powerLimit[	33	],	"c5_34");
		 rng[1][	2256 + 	816	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	34	],	angle[	192	+ i ]),	model.prod(	susceptance[	34	],	angle[	408	+ i ])),	-powerLimit[	34	],	"c5_35");
		 rng[1][	2256 + 	840	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	35	],	angle[	192	+ i ]),	model.prod(	susceptance[	35	],	angle[	408	+ i ])),	-powerLimit[	35	],	"c5_36");
		 rng[1][	2256 + 	864	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	36	],	angle[	192	+ i ]),	model.prod(	susceptance[	36	],	angle[	432	+ i ])),	-powerLimit[	36	],	"c5_37");
		 rng[1][	2256 + 	888	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	37	],	angle[	192	+ i ]),	model.prod(	susceptance[	37	],	angle[	432	+ i ])),	-powerLimit[	37	],	"c5_38");
		 rng[1][	2256 + 	912	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	38	],	angle[	192	+ i ]),	model.prod(	susceptance[	38	],	angle[	432	+ i ])),	-powerLimit[	38	],	"c5_39");
		 rng[1][	2256 + 	936	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	39	],	angle[	192	+ i ]),	model.prod(	susceptance[	39	],	angle[	432	+ i ])),	-powerLimit[	39	],	"c5_40");
		 rng[1][	2256 + 	960	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	40	],	angle[	192	+ i ]),	model.prod(	susceptance[	40	],	angle[	432	+ i ])),	-powerLimit[	40	],	"c5_41");
		 rng[1][	2256 + 	984	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	41	],	angle[	216	+ i ]),	model.prod(	susceptance[	41	],	angle[	24	+ i ])),	-powerLimit[	41	],	"c5_42");
		 rng[1][	2256 + 	1008	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	42	],	angle[	216	+ i ]),	model.prod(	susceptance[	42	],	angle[	24	+ i ])),	-powerLimit[	42	],	"c5_43");
		 rng[1][	2256 + 	1032	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	43	],	angle[	216	+ i ]),	model.prod(	susceptance[	43	],	angle[	24	+ i ])),	-powerLimit[	43	],	"c5_44");
		 rng[1][	2256 + 	1056	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	44	],	angle[	216	+ i ]),	model.prod(	susceptance[	44	],	angle[	336	+ i ])),	-powerLimit[	44	],	"c5_45");
		 rng[1][	2256 + 	1080	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	45	],	angle[	216	+ i ]),	model.prod(	susceptance[	45	],	angle[	480	+ i ])),	-powerLimit[	45	],	"c5_46");
		 rng[1][	2256 + 	1104	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	46	],	angle[	240	+ i ]),	model.prod(	susceptance[	46	],	angle[	96	+ i ])),	-powerLimit[	46	],	"c5_47");
		 rng[1][	2256 + 	1128	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	47	],	angle[	240	+ i ]),	model.prod(	susceptance[	47	],	angle[	96	+ i ])),	-powerLimit[	47	],	"c5_48");
		 rng[1][	2256 + 	1152	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	48	],	angle[	240	+ i ]),	model.prod(	susceptance[	48	],	angle[	96	+ i ])),	-powerLimit[	48	],	"c5_49");
		 rng[1][	2256 + 	1176	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	49	],	angle[	240	+ i ]),	model.prod(	susceptance[	49	],	angle[	96	+ i ])),	-powerLimit[	49	],	"c5_50");
		 rng[1][	2256 + 	1200	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	50	],	angle[	240	+ i ]),	model.prod(	susceptance[	50	],	angle[	408	+ i ])),	-powerLimit[	50	],	"c5_51");
		 rng[1][	2256 + 	1224	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	51	],	angle[	264	+ i ]),	model.prod(	susceptance[	51	],	angle[	48	+ i ])),	-powerLimit[	51	],	"c5_52");
		 rng[1][	2256 + 	1248	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	52	],	angle[	264	+ i ]),	model.prod(	susceptance[	52	],	angle[	48	+ i ])),	-powerLimit[	52	],	"c5_53");
		 rng[1][	2256 + 	1272	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	53	],	angle[	264	+ i ]),	model.prod(	susceptance[	53	],	angle[	408	+ i ])),	-powerLimit[	53	],	"c5_54");
		 rng[1][	2256 + 	1296	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	54	],	angle[	264	+ i ]),	model.prod(	susceptance[	54	],	angle[	408	+ i ])),	-powerLimit[	54	],	"c5_55");
		 rng[1][	2256 + 	1320	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	55	],	angle[	288	+ i ]),	model.prod(	susceptance[	55	],	angle[	384	+ i ])),	-powerLimit[	55	],	"c5_56");
		 rng[1][	2256 + 	1344	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	56	],	angle[	288	+ i ]),	model.prod(	susceptance[	56	],	angle[	384	+ i ])),	-powerLimit[	56	],	"c5_57");
		 rng[1][	2256 + 	1368	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	57	],	angle[	288	+ i ]),	model.prod(	susceptance[	57	],	angle[	336	+ i ])),	-powerLimit[	57	],	"c5_58");
		 rng[1][	2256 + 	1392	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	58	],	angle[	288	+ i ]),	model.prod(	susceptance[	58	],	angle[	336	+ i ])),	-powerLimit[	58	],	"c5_59");
		 rng[1][	2256 + 	1416	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	59	],	angle[	288	+ i ]),	model.prod(	susceptance[	59	],	angle[	336	+ i ])),	-powerLimit[	59	],	"c5_60");
		 rng[1][	2256 + 	1440	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	60	],	angle[	288	+ i ]),	model.prod(	susceptance[	60	],	angle[	336	+ i ])),	-powerLimit[	60	],	"c5_61");
		 rng[1][	2256 + 	1464	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	61	],	angle[	336	+ i ]),	model.prod(	susceptance[	61	],	angle[	456	+ i ])),	-powerLimit[	61	],	"c5_62");
		 rng[1][	2256 + 	1488	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	62	],	angle[	336	+ i ]),	model.prod(	susceptance[	62	],	angle[	456	+ i ])),	-powerLimit[	62	],	"c5_63");
		 rng[1][	2256 + 	1512	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	63	],	angle[	360	+ i ]),	model.prod(	susceptance[	63	],	angle[	48	+ i ])),	-powerLimit[	63	],	"c5_64");
		 rng[1][	2256 + 	1536	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	64	],	angle[	360	+ i ]),	model.prod(	susceptance[	64	],	angle[	48	+ i ])),	-powerLimit[	64	],	"c5_65");
		 rng[1][	2256 + 	1560	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	65	],	angle[	360	+ i ]),	model.prod(	susceptance[	65	],	angle[	48	+ i ])),	-powerLimit[	65	],	"c5_66");
		 rng[1][	2256 + 	1584	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	66	],	angle[	360	+ i ]),	model.prod(	susceptance[	66	],	angle[	48	+ i ])),	-powerLimit[	66	],	"c5_67");
		 rng[1][	2256 + 	1608	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	67	],	angle[	384	+ i ]),	model.prod(	susceptance[	67	],	angle[	48	+ i ])),	-powerLimit[	67	],	"c5_68");
		 rng[1][	2256 + 	1632	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	68	],	angle[	384	+ i ]),	model.prod(	susceptance[	68	],	angle[	48	+ i ])),	-powerLimit[	68	],	"c5_69");
		 rng[1][	2256 + 	1656	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	69	],	angle[	384	+ i ]),	model.prod(	susceptance[	69	],	angle[	192	+ i ])),	-powerLimit[	69	],	"c5_70");
		 rng[1][	2256 + 	1680	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	70	],	angle[	384	+ i ]),	model.prod(	susceptance[	70	],	angle[	192	+ i ])),	-powerLimit[	70	],	"c5_71");
		 rng[1][	2256 + 	1704	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	71	],	angle[	384	+ i ]),	model.prod(	susceptance[	71	],	angle[	432	+ i ])),	-powerLimit[	71	],	"c5_72");
		 rng[1][	2256 + 	1728	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	72	],	angle[	408	+ i ]),	model.prod(	susceptance[	72	],	angle[	48	+ i ])),	-powerLimit[	72	],	"c5_73");
		 rng[1][	2256 + 	1752	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	73	],	angle[	408	+ i ]),	model.prod(	susceptance[	73	],	angle[	48	+ i ])),	-powerLimit[	73	],	"c5_74");
		 rng[1][	2256 + 	1776	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	74	],	angle[	408	+ i ]),	model.prod(	susceptance[	74	],	angle[	48	+ i ])),	-powerLimit[	74	],	"c5_75");
		 rng[1][	2256 + 	1800	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	75	],	angle[	408	+ i ]),	model.prod(	susceptance[	75	],	angle[	48	+ i ])),	-powerLimit[	75	],	"c5_76");
		 rng[1][	2256 + 	1824	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	76	],	angle[	432	+ i ]),	model.prod(	susceptance[	76	],	angle[	96	+ i ])),	-powerLimit[	76	],	"c5_77");
		 rng[1][	2256 + 	1848	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	77	],	angle[	432	+ i ]),	model.prod(	susceptance[	77	],	angle[	96	+ i ])),	-powerLimit[	77	],	"c5_78");
		 rng[1][	2256 + 	1872	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	78	],	angle[	0	+ i ]),	model.prod(	susceptance[	78	],	angle[	288	+ i ])),	-powerLimit[	78	],	"c5_79");
		 rng[1][	2256 + 	1896	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	79	],	angle[	0	+ i ]),	model.prod(	susceptance[	79	],	angle[	120	+ i ])),	-powerLimit[	79	],	"c5_80");
		 rng[1][	2256 + 	1920	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	80	],	angle[	120	+ i ]),	model.prod(	susceptance[	80	],	angle[	216	+ i ])),	-powerLimit[	80	],	"c5_81");
		 rng[1][	2256 + 	1944	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	81	],	angle[	288	+ i ]),	model.prod(	susceptance[	81	],	angle[	48	+ i ])),	-powerLimit[	81	],	"c5_82");
		 rng[1][	2256 + 	1968	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	82	],	angle[	0	+ i ]),	model.prod(	susceptance[	82	],	angle[	432	+ i ])),	-powerLimit[	82	],	"c5_83");
		 rng[1][	2256 + 	1992	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	83	],	angle[	432	+ i ]),	model.prod(	susceptance[	83	],	angle[	48	+ i ])),	-powerLimit[	83	],	"c5_84");
		 rng[1][	2256 + 	2016	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	84	],	angle[	432	+ i ]),	model.prod(	susceptance[	84	],	angle[	96	+ i ])),	-powerLimit[	84	],	"c5_85");
		 rng[1][	2256 + 	2040	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	85	],	angle[	96	+ i ]),	model.prod(	susceptance[	85	],	angle[	504	+ i ])),	-powerLimit[	85	],	"c5_86");
		 rng[1][	2256 + 	2064	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	86	],	angle[	120	+ i ]),	model.prod(	susceptance[	86	],	angle[	528	+ i ])),	-powerLimit[	86	],	"c5_87");
		 rng[1][	2256 + 	2088	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	87	],	angle[	48	+ i ]),	model.prod(	susceptance[	87	],	angle[	312	+ i ])),	-powerLimit[	87	],	"c5_88");
		 rng[1][	2256 + 	2112	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	88	],	angle[	48	+ i ]),	model.prod(	susceptance[	88	],	angle[	312	+ i ])),	-powerLimit[	88	],	"c5_89");
		 rng[1][	2256 + 	2136	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	89	],	angle[	168	+ i ]),	model.prod(	susceptance[	89	],	angle[	120	+ i ])),	-powerLimit[	89	],	"c5_90");
		 rng[1][	2256 + 	2160	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	90	],	angle[	240	+ i ]),	model.prod(	susceptance[	90	],	angle[	432	+ i ])),	-powerLimit[	90	],	"c5_91");
		 rng[1][	2256 + 	2184	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	91	],	angle[	240	+ i ]),	model.prod(	susceptance[	91	],	angle[	432	+ i ])),	-powerLimit[	91	],	"c5_92");
		 rng[1][	2256 + 	2208	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	92	],	angle[	144	+ i ]),	model.prod(	susceptance[	92	],	angle[	48	+ i ])),	-powerLimit[	92	],	"c5_93");
		 rng[1][	2256 + 	2232	+ i ]	=	model.addGe(model.diff(model.prod(	susceptance[	93	],	angle[	144	+ i ]),	model.prod(	susceptance[	93	],	angle[	48	+ i ])),	-powerLimit[	93	],	"c5_94");
